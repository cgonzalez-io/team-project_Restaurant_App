...
class CustomerRepositoryImplTest {
    ...
    private void setupSampleData() throws SQLException {
        customerRepository.insert(new Customer("John", "Doe", "1234567890", "john.doe@example.com", "123 Main St"));
        customerRepository.insert(new Customer("Jane", "Doe", "0987654321", "jane.doe@example.com", "456 Elm St"));
    }

    @Test
    void testInsertValidCustomer() throws SQLException {
        Customer customer = new Customer("John", "Doe", "1234567890", "john.doe@example.com", "123 Main St");
    ...
    void testInsertCustomerWithNullValues() throws SQLException {
        Customer customer = new Customer("Jane", "Doe", null, "jane.doe@example.com", null);
        customerRepository.insert(customer);
        assertTrue(customer.getCustomerID() > 0);
    }
    ...
    void testUpdateExistingCustomerWithValidData() throws SQLException {
        ...
        Customer customer = new Customer("Alice", "Smith", "1112223333", "alice.smith@example.com", "789 Pine St");
        customerRepository.insert(customer);
    ...
    void testRetrieveExistingCustomerById() throws SQLException {
        Customer expectedCustomer = new Customer("John", "Doe", "1234567890", "john.doe@example.com", "123 Main St");
    ...
    @Test
    void testReturnsAllCustomersWhenDatabaseHasMultipleEntries() throws SQLException {
        ...
        try (MockedStatic<DatabaseUtil> mockedDatabaseUtil = Mockito.mockStatic(DatabaseUtil.class)) {
            ...
            when(mockResultSet.getString("Phone_Number")).thenReturn("1234567890", "0987654321");
