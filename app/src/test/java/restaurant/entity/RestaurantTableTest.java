...
class RestaurantTableTest {
    ...
    public void test_correct_string_format() {
        ...
        String expected = "RestaurantTable{tableID=1, tableNumber=10, seatingCapacity=4}";
    ...
    public void test_set_and_get_maximum_integer_values() {
        RestaurantTable restaurantTable = new RestaurantTable(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
    ...
    public void test_set_and_get_minimum_integer_values() {
        RestaurantTable restaurantTable = new RestaurantTable(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE);

        assertEquals(Integer.MIN_VALUE, restaurantTable.getTableID());
        assertEquals(Integer.MIN_VALUE, restaurantTable.getTableNumber());
        assertEquals(Integer.MIN_VALUE, restaurantTable.getSeatingCapacity());
    }

    @Test
    public void test_set_and_get_negative_values() {
        assertThrows(IllegalArgumentException.class, () -> new RestaurantTable(-101, -12, -4));
    }

    @Test
    public void test_set_negative_tableId() {
        RestaurantTable restaurantTable = new RestaurantTable(101, 12, 4);
        assertThrows(IllegalArgumentException.class, () -> restaurantTable.setTableID(-101));
    }

    @Test
    public void test_set_negative_tableNumber() {
        RestaurantTable restaurantTable = new RestaurantTable(101, 12, 4);
        assertThrows(IllegalArgumentException.class, () -> restaurantTable.setTableNumber(-12));
    }

    @Test
    public void test_set_negative_seatingCapacity() {
        RestaurantTable restaurantTable = new RestaurantTable(101, 12, 4);
        assertThrows(IllegalArgumentException.class, () -> restaurantTable.setSeatingCapacity(-4));
    }
}