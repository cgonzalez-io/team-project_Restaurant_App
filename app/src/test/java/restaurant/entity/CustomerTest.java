...
class CustomerTest {
  ...
  public void unit_test_extremely_long_strings_in_fields() {
    ...
    String expected =
        ...
        "', firstName='" + longString + "', lastName='" + longString +
        "', phone=987654321, email='" + longString +
        "@example.com', address='" + longString +
        "', next=ContactNode{name='" + longString + " " + longString +
        "', firstName='" + longString + "', lastName='" + longString +
        "', phone=1234567890, email='" + longString +
        "@example.com', address='" + longString + "', next=null}}";
    assertEquals(expected, customer.toString());
  }
