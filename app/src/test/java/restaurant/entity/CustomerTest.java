...
class CustomerTest {
    ...
    public void unit_test_correct_string_format_fully_populated_customer() {
        ...
        String expected =
            "Customer{customerId=1, name='John Smith', firstName='John', lastName='Smith', phone=987654321, email='john.smith@example.com', address='456 Elm St', next=ContactNode{name='Jane Doe', firstName='Jane', lastName='Doe', phone=1234567890, email='jane.doe@example.com', address='123 Main St', next=null}}";
