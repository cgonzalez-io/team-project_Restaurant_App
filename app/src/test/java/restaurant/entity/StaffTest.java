...
public class StaffTest {
    ...
    public void testStaffValues() {
        Staff staff = new Staff(1, "John", "Doe", "1234567890", "john@email.com", "123 Main St", "Server");
        assertEquals(1, staff.getStaffId());
    ...
    public void testEqualsNull() {
        Staff staff = new Staff(1, "John", "Doe", "1234567890", "john@email.com", "123 Main St", "Chef");
        assertNotEquals(staff, null);
    }

    @Test
    public void testEqualsDifferentStaffId() {
        Staff staff1 = new Staff(1, "John", "Doe", "1234567890", "john@email.com", "123 Main St", "Chef");
        Staff staff2 = new Staff(2, "John", "Doe", "1234567890", "john@email.com", "123 Main St", "Chef");
    ...
    public void testEqualsDifferentRole() {
        Staff staff1 = new Staff(1, "John", "Doe", "1234567890", "john@email.com", "123 Main St", "Chef");
        Staff staff2 = new Staff(1, "John", "Doe", "1234567890", "john@email.com", "123 Main St", "Manager");
        assertNotEquals(staff1, staff2);
    }
}
