...
public class Reservation {
    ...
    // Constructors
    public Reservation(int reservationID, int customerID, Date date, Time time, int numberOfPeople) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getReservationID(), getCustomerID(), getDate(), getTime(), getNumberOfPeople(), getNext());
    }
