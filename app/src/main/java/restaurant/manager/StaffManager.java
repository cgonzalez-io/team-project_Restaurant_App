...
public class StaffManager {
    ...
    private static void insertStaff() throws SQLException {
        System.out.println("Enter first name, last name, phone, email, address, and role:");
    ...
    private static void updateStaff() throws SQLException {
        ...
        System.out.println("Enter new first name, last name, phone, email, address, and role:");
