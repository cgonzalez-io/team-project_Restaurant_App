...
public class AssignmentManager {
    ...
    private static final StaffAssignmentRepository repository = new StaffAssignmentRepositoryImpl();
    ...
    private static void update() throws SQLException {
        ...
        try {
            ...
            Date date = Date.valueOf(scan.nextLine());
            Time time = Time.valueOf(scan.nextLine());
            System.out.println("Enter new Staff ID, new Table ID, new Date (yyyy-mm-dd), and new Time (hh:mm:ss):");
