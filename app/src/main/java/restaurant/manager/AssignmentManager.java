...
public class AssignmentManager {
  ...
  public void showMenu() {
    ...
    do {
      ...
      branching(choice);
    } while (!choice.equalsIgnoreCase("b") && !choice.equalsIgnoreCase("q"));
  }
  ...
  private static void insert() throws SQLException {
    System.out.println(
        "Enter Table ID, Staff ID, Date (yyyy-mm-dd), and Time (hh:mm:ss):");
    ...
    try {
      ...
      StaffAssignment assignment =
          new StaffAssignment(tableID, staffID, date, time);
      System.out.println("Inserting staff assignment..."
                         + " " + assignment);
  ...
  private static void update() throws SQLException {
    System.out.println("Enter existing Table ID, Staff ID, Date "
    ...
    try {
      ...
      Date date = Date.valueOf(scan.nextLine());
      Time time = Time.valueOf(scan.nextLine());
      StaffAssignment oldAssignment =
          repository.findById(tableID, staffID, date, time);
      ...
      StaffAssignment newAssignment =
          new StaffAssignment(newTableID, newStaffID, newDate, newTime);
  ...
  private static void deleteAssignment() throws SQLException {
    System.out.println("Enter Table ID, Staff ID, Date (yyyy-mm-dd), and "
