...
public class ReservationManager {
  ...
  private static void insert() throws SQLException {
    System.out.println("Enter the customer ID,number of people, "
    ...
    Reservation reservation =
        new Reservation(customerID, date, time, numberOfPeople);
  ...
  public void showMenu() {
    ...
    do {
      ...
      branching(choice);
    } while (!choice.toLowerCase().equals("b") &&
             !choice.toLowerCase().equals("q"));
  }
}
