...
public interface BenchmarkTool {
    ...
    */
    Integer[] generateTestDataBinary(int size);
     ...
     * @return generated test set.
     */
    Integer[] generateTestDataHalves(int size);
     ...
     * @return
     */
    Integer[] generateTestDataHalfRandom(int size);
     ...
     * @return b value
     */
    double computeDoublingFormula(double t1, double t2);
     ...
     * @return b value
     */
    double benchmarkInsertionSort(Integer[] small, Integer[] large);
     ...
     * @return b value
     */
    double benchmarkShellsort(Integer[] small, Integer[] large);
